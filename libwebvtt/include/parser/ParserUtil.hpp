#ifndef LIBWEBVTT_INCLUDE_PARSER_OBJECT_PARSER_PARSER_UTIL_HPP_
#define LIBWEBVTT_INCLUDE_PARSER_OBJECT_PARSER_PARSER_UTIL_HPP_
...
*/
  ...
  static constexpr std::u32string_view VOICE_ATTRIBUTE_MARK = U"voice";
  ...
  static std::u32string_view makeStringViewFromIterator(std::u32string_view input,
  ...
  static bool checkIfCSSSIdentifierBeginningRightFormat(std::u32string_view input);
  static bool checkIfCSSIdentifierAllowedCharacter(char32_t input);
};
}; // namespace webvtt

#endif // LIBWEBVTT_INCLUDE_PARSER_OBJECT_PARSER_PARSER_UTIL_HPP_